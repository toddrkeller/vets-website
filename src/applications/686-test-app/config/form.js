...
import fullSchema from '../686T-schema.json';
// In a real app this would be imported from `vets-json-schema`:
// import fullSchema from 'vets-json-schema/dist/686T-schema.json';
...
const formConfig = {
  ...
  chapters: {
    applicantPreferencesChapter: {
      title: 'Applicant Preferences',
      pages: {
        pageOne: {
          path: 'applicant-preferences',
          title: 'What do you want to do:',
          uiSchema: {
            serviceHistory: {
              'ui:title': 'fill out service history',
            },
            additionalInfo: {
              'ui:title': 'fill out additional information',
            },
          },
          schema: {
            type: 'object',
    ...
    serviceHistoryChapter: {
      ...
      pages: {
        [formPages.serviceHistory]: {
          depends: form => form.serviceHistory === true,
    ...
    additionalInformationChapter: {
      ...
      pages: {
        [formPages.contactInformation]: {
          depends: form => form.additionalInfo === true,
