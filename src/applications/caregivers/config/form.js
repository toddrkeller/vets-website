...
import IntroductionPage from '../../burials/components/IntroductionPage';
import ConfirmationPage from '../../burials/containers/ConfirmationPage';
import ErrorText from '../../burials/components/ErrorText';
...
import {
  ...
  submit,
} from '../../burials/helpers';
import {
  relationshipLabels,
  locationOfDeathLabels,
  allowanceLabels,
} from '../../burials/labels.jsx';
...
import toursOfDutyUI from '../../burials/definitions/toursOfDuty';
import fileUploadUI from 'platform/forms-system/src/js/definitions/file';
import currencyUI from 'platform/forms-system/src/js/definitions/currency';
import {
  validateBurialAndDeathDates,
  validateCentralMailPostalCode,
} from '../../burials/validation';
import migrations from '../../burials/migrations';
...
const isEligibleNonService = veteranBurialDate =>
  moment()
    .startOf('day')
    .subtract(2, 'years')
          ...
          uiSchema: {
            ...
            relationship: {
              ...
              other: {
                ...
                'ui:required': form =>
                  _.get('relationship.type', form) === 'other',
                'ui:options': {
                  expandUnder: 'type',
          ...
          uiSchema: {
            ...
            locationOfDeath: {
              ...
              other: {
                'ui:title': 'Please specify',
                'ui:required': form =>
                  _.get('locationOfDeath.location', form) === 'other',
                'ui:options': {
    ...
    benefitsSelection: {
      ...
      pages: {
        benefitsSelection: {
          ...
          uiSchema: {
            'view:claimedBenefits': {
              ...
              amountIncurred: _.merge(
                currencyUI('Transportation amount incurred'),
                {
                  'ui:required': form =>
                    _.get('view:claimedBenefits.transportation', form) === true,
                  'ui:options': {
        ...
        burialAllowance: {
          ...
          depends: form =>
            _.get('view:claimedBenefits.burialAllowance', form) === true,
          uiSchema: {
            'ui:title': 'Burial allowance',
            burialAllowanceRequested: {
            ...
            previouslyReceivedAllowance: {
              ...
              'ui:widget': 'yesNo',
              'ui:required': form =>
                _.get('relationship.type', form) === 'spouse',
              'ui:options': {
        ...
        plotAllowance: {
          ...
          depends: form =>
            _.get('view:claimedBenefits.plotAllowance', form) === true,
          uiSchema: {
            ...
            amountGovtContribution: _.merge(
      ...
      pages: {
        ...
        documentUpload: {
          ...
          uiSchema: {
            ...
            transportationReceipts: _.assign(
              fileUploadUI(
