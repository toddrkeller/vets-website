...
import { addressModalContent } from '../utils/helpers';

import MailingAddress from '../../../applications/personalization/profile360/vet360/components/MailingAddress';
import Vet360InitializeID from '../../../applications/personalization/profile360/vet360/containers/InitializeID';
import Vet360PendingTransactionCategory from '../../../applications/personalization/profile360/vet360/containers/PendingTransactionCategory';
import { TRANSACTION_CATEGORY_TYPES } from '../../../applications/personalization/profile360/vet360/constants';

export class AddressSection extends React.Component {
  constructor(props) {
    super(props);
    this.state = { addressHelpVisible: false };
  }
      ...
      <Vet360InitializeID>
        ...
        >
          ...
          <div className="address-block">
            <MailingAddress />
            <button className="va-button-link" onClick={this.openAddressHelp}>
              What is this?
            </button>
          </div>
          <Modal
          ...
          />
          <p>
            When you download a letter, it will show this address. If this
            address is incorrect you may want to update it, but your letter will
            still be valid even with the incorrect address.
          </p>
        </Vet360PendingTransactionCategory>
      </Vet360InitializeID>
    );
